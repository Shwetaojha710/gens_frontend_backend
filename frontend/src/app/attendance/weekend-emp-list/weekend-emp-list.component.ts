...
@Component({
  selector: 'app-weekend-emp-list',
   imports: [NgSelectModule,
    FormsModule, CommonModule],
  templateUrl: './weekend-emp-list.component.html',
  styleUrl: './weekend-emp-list.component.css'
})
// export class WeekendEmpListComponent {
...
export class WeekendEmpListComponent {
  ...
  constructor(
    ...
    this.obj['is_comp_off_approve']=false
  ...
  itemsPerPage = 10;
  totalPages = 0;
  leaveStatus: any = [{ value: false, label: 'Pending' }, { value: true, label: 'Approved' }]
 ...
 checkUncheckAll() {
  ...
  fetchAttendance() {
    ...
    this.originalList = []
    this.attendanceService.getweekendAttendance(this.obj).subscribe((response: any) => {
  ...
  correctAll() {
    ...
    this.attendanceService.AddCompOff(selectedEmployees).subscribe((data: {
      [x: string]: any;
    }) => {
      if (data['status'] == true) {
        this.notyf.success(data['message']);
